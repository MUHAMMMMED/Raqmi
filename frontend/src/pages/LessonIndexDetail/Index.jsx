...
const Index = () => {
  ...
  const [activeTab, setActiveTab] = useState('book'); // 'book' أو 'lesson'
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.tabsContainer}>
        <div className={styles.tabs}>
          ...
          >
            ...
            <span className={styles.badge}>{lessonIndex.book_lesson.length}</span>
          </button>
          <button
          ...
          >
            ...
            <span className={styles.badge}>{lessonIndex.lesson.lesson_block.length}</span>
          </button>
        </div>
      </div>
      ...
      {activeTab === 'book' ? (
        ...
        <div className={styles.section}>
          <div className={styles.lessonHeader}>
            <h2 className={styles.sectionTitle}>
              دروس الكتاب ({lessonIndex.book_lesson.length})
            </h2>
          ...
          {lessonIndex.book_lesson.map((bookLesson) => (
            <div key={bookLesson.id} className={styles.bookLesson}>
                ...
                <div className={styles.lessonHeader}>
                  ...
                  >
                    {expandedLessons[bookLesson.id] ? (
                      ...
                      <>
                        <span>عرض البلوكات ({bookLesson.blocks.length})</span>
                        <FaChevronDown />
                      </>
                    )}
                  </button>
              ...
              {/* البلوكات - تظهر فقط إذا تم توسيع الدرس */}
              {expandedLessons[bookLesson.id] && (
        ...
        /* محتوى الدرس التعليمي */
        <div className={styles.section}>
          <div className={styles.lessonHeader}>
            <h2 className={styles.sectionTitle}>
              محتوى الدرس ({lessonIndex.lesson.lesson_block.length})
            </h2>
            <div style={{ display: 'flex', gap: '8px' }}>
              <button
                className={styles.toggleButton}
            ...
            <div key={lessonBlock.id} className={styles.lessonBlock}>
              <div className={styles.lessonDetails}>
                ...
                <div className={styles.lessonInfoGrid}>
                  ...
                  {lessonBlock.linked_blocks && lessonBlock.linked_blocks.length > 0 && (
                    <div className={styles.infoItem}>
                      <FaBookmark className={styles.infoIcon} />
                  ...
                  {lessonBlock.cards && lessonBlock.cards.length > 0 && (
                    <div className={styles.infoItem}>
              ...
              {/* التفاصيل الإضافية - تظهر فقط إذا تم توسيع البلوك */}
              {expandedLessons[lessonBlock.id] && (
                <div className={styles.blockDetails}>
                  {/* الأهداف التعليمية */}
                  {lessonBlock.course_block_objective && lessonBlock.course_block_objective.length > 0 && (
                  ...
                  {/* التمارين */}
                  {lessonBlock.course_block_exercises && lessonBlock.course_block_exercises.length > 0 && (
                    <div className={styles.detailSection}>
                      <h4 className={styles.detailTitle}>
                  ...
                  {/* البطاقات - باستخدام FlashCardItem */}
                  {lessonBlock.cards && lessonBlock.cards.length > 0 && (
                    <div className={styles.detailSection}>
                      <h4 className={styles.detailTitle}>
